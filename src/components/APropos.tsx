    ...
    <div className="min-h-screen bg-white py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-[#1F4E79] mb-6">À propos</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#1F4E79] flex items-center justify-center">
                <Target className="text-[#C9A24D]" size={24} />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-[#1F4E79] mb-3">Notre Mission</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#1F4E79] mb-3">Notre Vision</h3>
                <p className="text-gray-600 leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#1F4E79] mb-3">Notre Positionnement</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#1F4E79] mb-3">Notre Portée</h3>
                <p className="text-gray-600 leading-relaxed">
        ...
        <div className="bg-gray-50 rounded-2xl p-12">
          <h2 className="text-3xl font-bold text-[#1F4E79] mb-8 text-center">
            Notre Expertise
          </h2>
        ...
        <div className="mt-20 text-center">
          ...
          <p className="mt-6 text-lg text-[#1F4E79] font-semibold">
            Vision Plus
          </p>
        </div>
      </div>
