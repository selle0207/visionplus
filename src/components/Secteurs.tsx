    ...
    <div className="min-h-screen bg-gray-50 py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-[#1F4E79] mb-6">
          ...
          {secteurs.map((secteur, index) => (
            ...
            >
              <div className="md:flex">
                <div className="md:w-1/3 bg-gradient-to-br from-[#1F4E79] to-[#153554] p-12 flex flex-col items-center justify-center text-white">
        ...
        <div className="mt-20 bg-white rounded-xl p-12 shadow-md text-center">
          ...
          <button className="bg-gradient-to-r from-[#1F4E79] to-[#153554] text-white px-10 py-4 rounded-lg font-semibold text-lg hover:from-[#153554] hover:to-[#1F4E79] transition-all">
