    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-[#0F2A44] mb-6">Nos Valeurs</h1>
          ...
          {valeurs.map((valeur, index) => (
            ...
            >
              <div className="md:flex items-center">
                <div
                  className="md:w-1/4 p-12 flex flex-col items-center justify-center text-white"
                  style={{ backgroundColor: valeur.color }}
                >
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-br from-[#0F2A44] to-[#1F4E79] rounded-2xl p-12 text-white">
